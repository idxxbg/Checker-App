...
import 'package:checker_app/app/app.dart';
import 'package:checker_app/data/models/isar_guest.dart';
import 'package:checker_app/data/repository/isar_guest_repo.dart';
...
import 'presentation/view/list_screen.dart';
        ...
        onGenerateRoute: (RouteSettings settings) {
          switch (settings.name) {
            case "/":
              ...
              //   builder: (_) => App(title: "Guest Form"),
              // );
              return MaterialPageRoute(builder: (_)=> const App(title: "Guest Form"));
            case "/list":
